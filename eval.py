...
def evaluation_proposal(opt):
    ...
    print
    "AR@1 is \t", np.mean(uniform_recall_valid[:, 0])
    print
    "AR@5 is \t", np.mean(uniform_recall_valid[:, 4])
    print
    "AR@10 is \t", np.mean(uniform_recall_valid[:, 9])
    print
    "AR@100 is \t", np.mean(uniform_recall_valid[:, -1])
